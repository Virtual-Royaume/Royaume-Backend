...
// Get MySQL data :
const members: any[] = (await connection.execute("SELECT * FROM member"))[0] as any;
const membersActivity: any[] = (await connection.execute("SELECT * FROM member_activity"))[0] as any;
const serverActivity: any[] = (await connection.execute("SELECT * FROM server_activity"))[0] as any;
